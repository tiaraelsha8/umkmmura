...
<head>
    ...
    <title>UMKM KABUPATEN MURUNG RAYA</title>
    ...
    <link href="{{ asset('templateadmin/vendor/datatables/dataTables.bootstrap4.min.css') }}" rel="stylesheet">
...
<body id="page-top">
    ...
    <script src="{{ asset('templateadmin/vendor/datatables/jquery.dataTables.min.js') }}"></script>
    <script src="{{ asset('templateadmin/vendor/datatables/dataTables.bootstrap4.min.js') }}"></script>
